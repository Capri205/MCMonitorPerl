...
/* Fetch updates from database using ajax and via controller
** Makes an ajax call to the controller which fetches state for all servers
** from the database and sets the globalstate object so the web page
** can be updated accordingly and trigger specific events
**
** @parms none
** returns nothing
*/
